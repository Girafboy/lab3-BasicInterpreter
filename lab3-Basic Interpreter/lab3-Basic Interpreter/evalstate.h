...
/*
 * Method: eraseValue
 * Usage: state.eraseValue(var);
 * ---------------------------------------
 * Erase the key-value both according to the specified variable.
 */

   void eraseValue(std::string var);

/*
 * Method: clear
 * Usage: state.clear();
 * ---------------------------------------
 * Clear all the key-value in the symbolTable.
 */
